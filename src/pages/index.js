...
class Home extends Component{
    ...
    componentDidMount(){
        ...
        this.WWD.anim
            .fromTo(this.WWD.outline, 1.5, {drawSVG:"100% 100%"}, {ease:"power1.inOut", drawSVG:"0% 100%", stagger: 0.1})
        ...
        this.Webdev.anim = new TimelineLite({
            ease:"power3.easeOut",
            scrollTrigger: {
        ...
        .fromTo('.star .real, .star .fict', 1.5, {drawSVG:"0%"}, {ease:"power1.inOut", drawSVG:"100%", stagger: 0.1})
                ...
                <div className="wrapper" ref={div => this.Welcome.wrapper = div}>
                    <div className="block">
                        ...
                        <h1 className="vertical-move" ref={h1 => this.Welcome.wrapperH1 = h1}>
                            <span><span ref={span => this.Welcome.head[0] = span}>We build the best brands</span></span>
                            <span><span ref={span => this.Welcome.head[1] = span}>and websites in the world.</span></span>
                            <span><span ref={span => this.Welcome.head[2] = span}>Just ask us.</span></span>
                        </h1>
                    </div>
                </div>
                <h1 ref={h1 => this.Welcome.H1 = h1}>We build the best brands and websites in the world. Just <AniLink paintDrip hex="#525375" to='/contact'>ask us</AniLink>.</h1>
                <img className='bottom-text' src={WelcomeBottomText} alt="" ref={img => this.Welcome.bottom = img}/>
            </section>
                    ...
                    <div className='col1'>
                        ...
                        <div className="outline">
                            <svg width="393" height="338" viewBox="0 0 393 338" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path ref={path => this.WWD.outline = path} opacity="0.5" d="M1.30005 207.2C19.8 175.5 79 84.3003 188.8 55.6003C225.3 46.1003 292.3 28.6003 343.1 69.2003C387.1 104.3 398.9 166.9 387 214.2C366.3 297 268.2 352.5 180.9 331.9C122.8 318.2 70.4001 271.1 57.2001 210.2C35.5 110 130.2 18.0003 212.8 4.10031C225.8 1.90031 268.5 -5.29968 306 21.2003C358.5 58.2003 355.8 129.1 355.4 135.5" stroke="white" stroke-width="3" stroke-miterlimit="10"/>
                            </svg>
                        </div>
                    </div>
