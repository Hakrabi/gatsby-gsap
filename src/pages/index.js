...
import tempTeam from "../imgs/TEMPORAL/team.png"
...
class Home extends Component{
    ...
    componentDidMount(){
        ...
        // TweenLite.set(this.wwdSection,{backgroundPosition:'-1000px 0px'});
        ...
        // gsap.set([this.wwd1,this.wwd2,this.wwd3,this.wwdSection],{
        //     scrollTrigger: {
        //         trigger: this.wwdSection,
        //         start: "bottom bottom",
        //         markers: true
          ...
          <main id="home">
              ...
              <section className="what-we-do">
                  <div className="grid" ref={div => this.wwdSection = div}>
                      ...
                      <div className='col2'>
                          <p className="big" ref={div => this.wwdText = div}>
              ...
              <section className="webdev" ref={section => this.webdevTrigger = section}>
                  <div className="grid mw900">
                      <div className='col1 col-center'>
                          ...
                          <p>Convenient, fast and understandable website whether it is a landing page, online store or
                              CRM. <br/><br/>
                              ...
                              of your project: from developing an idea, and creating a layout, to lifelong support.</p>
                      </div>
              ...
              <section className="tech">
                  <div className="grid mw900">
                      <div className="col1">
                          <h2>
                              <span ref={span => this.webdev1 = span}>PROVEN</span>
                              <span ref={span => this.webdev2 = span}>TECHNO</span>
                              <span ref={span => this.webdev3 = span}>LOGY</span>
                              <span ref={span => this.webdev4 = span}>STACK</span>
                          </h2>
                      </div>
                      <div className="col2 col-center">
                          <img className="mb" src={webdevPC} alt=""/>
              ...
              <section className="still-reading">
                  <div className="container flex-center">
                      <h2 className="mb">
                          <span ref={span => this.webdev1 = span}>WHY YOU STILL</span>
                          <span ref={span => this.webdev2 = span}>READING THIS?</span>
                      </h2>
